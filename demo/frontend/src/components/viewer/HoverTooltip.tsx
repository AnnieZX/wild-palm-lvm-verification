...
/**
 * Compact tooltip for bbox hover metadata.
 */
export function HoverTooltip({
  ...
  return (
    <div
      className="pointer-events-none absolute z-30 max-w-[220px] rounded border border-slate-600 bg-slate-950 px-2.5 py-1.5"
      style={{
