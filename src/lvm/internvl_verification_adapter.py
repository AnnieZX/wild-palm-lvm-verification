"""InternVL3 verification adapter for the frozen verification framework."""
...
def build_internvl_adapter(
    *,
    model_name: str,
    batch_size: int = 1,
    device_map: str = "auto",
    max_new_tokens: int = 512,
    model_key: str = "internvl3",
    condition: str = "",
    experiment_id: str = "",
) -> "InternVLVerificationAdapter":
    """Factory used by the verification adapter registry."""
    return InternVLVerificationAdapter(
...
class InternVLVerificationAdapter(BaseVerificationAdapter):
    """
    InternVL3 verification adapter.
    ...
    def __init__(
        ...
        # Official InternVL chat path is single-sample; keep batch_size for schema parity.
        self.batch_size = batch_size
        self.max_new_tokens = max_new_tokens
        self.model_key = model_key
        self.condition = condition
        self.experiment_id = experiment_id
        self._verifier = InternVLVerifier(model_name=model_name, device_map=device_map)
    ...
    def verify(self, job: VerificationJob) -> VerificationOutcome:
        """Run InternVL3 inference for one verification sample."""
        ...
        generation_meta = {
            ...
            "do_sample": False,
            "max_num_tiles": self._verifier.max_num_tiles,
            "use_flash_attn": self._verifier.use_flash_attn,
            "dtype": "bfloat16",
        }
        try:
            ...
            record["generation"] = generation_meta
