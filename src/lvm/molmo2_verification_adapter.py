"""Molmo2-8B verification adapter for the frozen verification framework."""
...
def build_molmo2_adapter(
    *,
    model_name: str,
    batch_size: int = 1,
    device_map: str = "auto",
    max_new_tokens: int = 512,
    model_key: str = "molmo2_8b",
    condition: str = "",
    experiment_id: str = "",
) -> "Molmo2VerificationAdapter":
    """Factory used by the verification adapter registry."""
    return Molmo2VerificationAdapter(
...
class Molmo2VerificationAdapter(BaseVerificationAdapter):
    """
    Molmo2-8B (allenai/Molmo2-8B) verification adapter.
    ...
    def verify(self, job: VerificationJob) -> VerificationOutcome:
        """Run Molmo2-8B inference for one verification sample."""
